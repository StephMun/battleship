'''
    battleship.py
    Estefania Munguia
    Purpose: This program reads in a file of ship placements
    and places the ships on the battleship boards accordingly.
    Then it reads in a guesses file and responds to the ships
    on the board based on its effects.
    CSC 120, 1F, Fall 2018
'''
